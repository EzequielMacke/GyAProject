    ...
    <div class="content-wrapper">
                ...
                <div class="ph">
                    <div>
                        <div class="ph-crumb">
                            ...
                            <i class="fas fa-chevron-right"></i>
                            <a href="{{ route('obras.show', $obra->id) }}" style="color:inherit;text-decoration:none;">{{ $obra->nombre }}</a>
                            <i class="fas fa-chevron-right"></i> Editar
                        </div>
                        <h1 class="ph-title">Editar <em>obra</em></h1>
                        <p class="ph-sub">{{ $obra->nombre }}</p>
                    </div>
                    <div class="ph-right">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form id="form-edit" action="{{ route('obras.update', $obra->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="form-card-body" style="display:flex;flex-direction:column;gap:1rem;">
                                ...
                                <div>
                                    ...
                                    <textarea id="observacion" name="observacion" class="field-input"
                                              placeholder="Detalles adicionales de la obra">{{ old('observacion', $obra->observacion) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-card">
                            ...
                            <div class="form-card-body">
                                ...
                                <input type="text" id="direccion_link" class="field-input field-readonly"
                                       placeholder="Hacé clic en el mapa para seleccionar la ubicación"
                                       readonly value="{{ old('direccion', $obra->direccion) }}">
                                <p class="field-hint"><i class="fas fa-info-circle"></i> Hacé clic en el mapa para cambiar la ubicación. El enlace se actualiza automáticamente.</p>
                            </div>
                        </div>
