					...
					<div class="row w-100 justify-content-center mx-0 opciones-row mt-5">
						<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex align-items-stretch">
							<a href="#" class="opcion-card text-center">
								<span style="color:#00b894;"><i class="fas fa-cubes"></i></span>
								<div style="font-size:1.2rem; font-weight:600;">Insumos</div>
							</a>
						</div>
						<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4 d-flex align-items-stretch">
							<a href="{{ route('kits.index') }}" class="opcion-card text-center">
								<span style="color:#853724;"><i class="fas fa-box"></i></span>
								<div style="font-size:1.2rem; font-weight:600;">Kits</div>
							</a>
						</div>
					</div>
				</div>
