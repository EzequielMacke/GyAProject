            ...
            <div class="container-fluid">
                ...
                <div class="ph">
                    <div>
                        ...
                        <h1 class="ph-title">Control de Gastos — <em>{{ $obra->nombre ?? '-' }}</em></h1>
                        <p class="ph-sub">Seleccioná un presupuesto de la obra para gestionar sus gastos</p>
                    </div>
                    <div class="ph-right">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div id="cards-grid">
                    ...
                    @endphp
                    <a href="{{ route('control_gastos.create', ['obra' => $obra->id, 'presupuesto' => $presupuesto->id]) }}"
                       class="budget-card"
