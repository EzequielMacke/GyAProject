		...
		<div class="content-wrapper" style="min-height: 100vh; background: transparent;">
			<div class="container-fluid">
				<div class="card card-custom p-4 w-100" style="min-width:0;">
					<form action="{{ route('recibo_venta.store') }}" method="POST" class="w-100">
						<div class="row mb-3">
							<div class="col-8">
						...
						<div class="row mb-3">
							<div class="col-md-4 mb-2">
								...
								<input type="text" name="nro_recibo" class="form-control" id="nro_recibo" value="001-001-0000001" required>
							</div>
							<div class="col-md-4 mb-2">
