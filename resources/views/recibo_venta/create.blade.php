    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="ph">
                    <div>
                        ...
                        <h1 class="ph-title">Nuevo <em>recibo de venta</em></h1>
                        <p class="ph-sub">{{ $factura?->nro_factura ?? '' }}{{ $presupuesto ? ' — ' . $presupuesto->clave : '' }}</p>
                    </div>
                    <div class="ph-right">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form id="form-recibo" action="{{ route('recibo_venta.store') }}" method="POST">
                    @csrf
