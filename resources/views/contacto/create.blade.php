    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="ph">
                    <div>
                        ...
                        <h1 class="ph-title">Nuevo <em>contacto</em></h1>
                        <p class="ph-sub">Agregar persona o empresa vinculada a la obra</p>
                    </div>
                    <div class="ph-right">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form id="form-contacto" action="{{ route('contacto.store') }}" method="POST">
                    @csrf
                                ...
                                <div>
                                    ...
                                    <select name="presupuesto_id" id="presupuesto_id" class="field-input">
                                        ...
                                        @foreach($presupuestos as $presupuesto)
                                            <option value="{{ $presupuesto->id }}" {{ old('presupuesto_id') == $presupuesto->id ? 'selected' : '' }}>
                                                {{ $presupuesto->clave }}
                                            </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-card-body">
                            ...
                            <textarea name="observacion" id="observacion" class="field-input"
                                      placeholder="Ej: Llamar solo por la mañana">{{ old('observacion') }}</textarea>
                        </div>
                    </div>
