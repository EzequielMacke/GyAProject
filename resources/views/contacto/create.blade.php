        ...
        <div class="content-wrapper" style="min-height: 100vh; background: transparent;">
            <div class="container-fluid">
                <div class="card card-custom p-4 w-100" style="min-width:0;">
                    <form action="{{ route('contacto.store') }}" method="POST" class="w-100">
                        <div class="row mb-3">
                            <div class="col-8">
                                <h2 class="mb-0">Agregar Contacto</h2>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nombre" class="form-control" id="nombre" required placeholder="Ej: Juan Pérez">
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="tipo_contacto" class="form-control" id="tipo_contacto" placeholder="Ej: Administrativo, Contacto de obra, Peticionario, etc.">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="telefono" class="form-control" id="telefono" placeholder="Ej: +595-123456">
                                </div>
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Ej: correo@ejemplo.com">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="observacion" class="form-control" id="observacion" rows="4" placeholder="Ej: Llamar solo por la mañana"></textarea>
                                </div>
                            </div>
                        </div>
                    </form>
