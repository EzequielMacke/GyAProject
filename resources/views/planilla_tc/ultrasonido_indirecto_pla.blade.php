...
<script>
    ...
    function abrirModalEliminarPunto(card) {
        cardAEliminar = card;
        document.getElementById('eliminar-punto-nombre').textContent = `U${card.dataset.idx}`;
    ...
    /* ─── Intercambiar puntos arrastrando los "cuadritos" ───────
       ...
       si soltás U3 sobre U1, esos dos cambian de identificación
       entre sí (U3 pasa a ser U1 y viceversa) y el resto de los
