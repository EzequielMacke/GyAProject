...
<head>
    ...
    <title>Nuevo Pedido para Obra</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Select2 — overrides para que combine con el diseño */
        ...
        /* Separador entre kit e insumo en el header */
        .header-sep {
    ...
    <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="ph">
                    <div>
                        <div class="ph-crumb">
                            ...
                            @if($obraModel)
                                ...
                                <i class="fas fa-chevron-right"></i>
                                <a href="{{ route('pedidobra.index', $obra) }}">Pedidos</a>
                                <i class="fas fa-chevron-right"></i>
                            @endif
                            Nuevo
                        </div>
                        <h1 class="ph-title">Nuevo <em>pedido</em></h1>
                    ...
                    <div class="ph-right">
                        ...
                        <a href="{{ route('pedidobra.index', $obra) }}" class="btn">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form id="form-create" action="{{ route('pedidobra.store') }}" method="POST">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    presupuestoSel.addEventListener('change', function () {
        const opt   = this.options[this.selectedIndex];
        const orden = opt.dataset.orden;
        if (this.value && orden) {
